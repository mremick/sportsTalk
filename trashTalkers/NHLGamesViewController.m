...
#import "NHLGamesViewController.h"
#import "ChatViewController.h"

@interface NHLGamesViewController ()
...
- (void)viewDidLoad
{
    ...
    [gamesQuery findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        if (!error) {
            ...
            [self.games addObjectsFromArray:[[objects objectAtIndex:0] objectForKey:@"NHLGames"]];
